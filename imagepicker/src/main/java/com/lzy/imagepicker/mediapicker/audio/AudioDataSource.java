...
import com.lzy.imagepicker.mediapicker.video.VideoItem;
...
public class AudioDataSource extends AbsDataSource<AudioItem,AudioFolder> {
    ...
    public AudioDataSource(FragmentActivity context, String path, OnMediaLoadedListener loadedListener) {

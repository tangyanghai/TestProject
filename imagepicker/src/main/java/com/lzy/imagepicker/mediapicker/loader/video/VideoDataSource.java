...
public class VideoDataSource extends AbsDataSource<VideoItem, VideoFolder> {
    ...
    public VideoDataSource(FragmentActivity context, String path, OnMediaLoadedListener<VideoFolder> loadedListener) {
    ...
    protected VideoItem translateDate(Cursor data) {
        ...
        int vedioDuration = data.getInt(data.getColumnIndexOrThrow(VIDEO_PROJECTION[7]));
        //封装实体
        ...
        videoItem.duration = vedioDuration;
        return videoItem;
    }
}

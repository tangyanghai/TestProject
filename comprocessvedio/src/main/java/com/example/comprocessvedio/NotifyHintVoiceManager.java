...
public class NotifyHintVoiceManager {
    ...
    private NotifyHintVoiceManager() {
        handler = new Handler(Looper.getMainLooper());
    }

    private static NotifyHintVoiceManager getInstance() {
        if (instance == null) {
            synchronized (NotifyHintVoiceManager.class) {
                if (instance == null) {
                    instance = new NotifyHintVoiceManager();
                }
            }
        }
        return instance;
